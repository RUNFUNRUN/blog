---
title: GitHub Actionsのeslintをbunを使う。
...
実際の導入しているプロジェクトはこのようになっています。

https://github.com/RUNFUNRUN/VALORANT-Oekaki-Chat/blob/main/.github/workflows/bun-eslint.yml
