...
export const useTOCItems = (): Primitive.TOCItemType[] => {
...
export const TocThumb = ({
  containerRef,
  ...props
}: ComponentProps<'div'> & RefProps) => {
  const thumbRef = useRef<HTMLDivElement>(null);
  const active = Primitive.useActiveAnchors();
  const update = (info: TocThumbType): void => {
...
const calc = (container: HTMLElement, active: string[]): TocThumbType => {
