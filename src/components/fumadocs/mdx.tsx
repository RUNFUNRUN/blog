...
import {
  ...
  CalloutDescription,
  CalloutTitle,
} from '@/components/fumadocs/components/callout';
import { Card, Cards } from '@/components/fumadocs/components/card';
import {
  CodeBlock,
  CodeBlockTab,
  CodeBlockTabs,
  ...
  Pre,
} from '@/components/fumadocs/components/codeblock';
import { Heading } from '@/components/fumadocs/components/heading';
...
export const createRelativeLink: typeof import('@/components/fumadocs/mdx.server').createRelativeLink =
  () => {
    throw new Error(
