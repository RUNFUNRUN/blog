...
import {
  ...
  TabsList,
  TabsTrigger,
} from '@/components/fumadocs/components/ui/tabs';
...
export const CodeBlock = ({
  ...
  return (
    ...
    >
        ...
        <div className='flex text-fd-muted-foreground items-center gap-2 h-9.5 border-b px-4'>
          {typeof icon === 'string' ? (
            <div
              ...
              // biome-ignore lint/security/noDangerouslySetInnerHtml: Icons are SVG generated from the repository's MDX at build time.
      ...
      {/* biome-ignore lint/a11y/useSemanticElements: Keep the upstream viewport markup for code block styling. */}
      <div
        ref={areaRef}
        {...viewportProps}
        role='region'
        // biome-ignore lint/a11y/noNoninteractiveTabindex: Keyboard users must be able to focus and scroll overflowing code.
        tabIndex={0}
        className={cn(
