...
} from '@/components/fumadocs/base/contexts/i18n';
import {
  SearchProvider,
  type SearchProviderProps,
} from '@/components/fumadocs/base/contexts/search';
import type { DefaultSearchDialogProps } from '@/components/fumadocs/components/dialog/search-default';
...
const DefaultSearchDialog = lazy(
  () => import('@/components/fumadocs/components/dialog/search-default'),
);
