...
import { useIsScrollTop } from '@/components/fumadocs/base/hooks/use-is-scroll-top';
  ...
  if (item.type === 'menu') {
    const children = item.items.map((child, j) => {
      if (child.type === 'custom') {
        // biome-ignore lint/suspicious/noArrayIndexKey: Custom navigation items have no ID and retain their configured order.
