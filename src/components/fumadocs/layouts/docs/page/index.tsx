...
import {
  TOCProvider,
  TOCScrollArea,
} from '@/components/fumadocs/components/toc';
import * as TocClerk from '@/components/fumadocs/components/toc/clerk';
import * as TocDefault from '@/components/fumadocs/components/toc/default';
import { buttonVariants } from '@/components/fumadocs/components/ui/button';
import { I18nLabel } from '@/components/fumadocs/contexts/i18n';
import {
...
} from '@/components/fumadocs/layouts/docs/page/client';
...
export const EditOnGitHub = (props: ComponentProps<'a'>) => {
  return (
    <a
      target='_blank'
