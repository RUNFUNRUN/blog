...
import * as Base from '@/components/fumadocs/components/sidebar/base';
import { createLinkItemRenderer } from '@/components/fumadocs/components/sidebar/link-item';
import { createPageTreeRenderer } from '@/components/fumadocs/components/sidebar/page-tree';
import { buttonVariants } from '@/components/fumadocs/components/ui/button';
import { SearchToggle } from '@/components/fumadocs/layouts/shared/search-toggle';
...
export {
  ...
  SidebarTrigger,
  SidebarViewport,
} from '@/components/fumadocs/components/sidebar/base';
