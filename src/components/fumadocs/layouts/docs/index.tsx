...
import { LinkItem } from '@/components/fumadocs/base/link-item';
import type { SidebarPageTreeComponents } from '@/components/fumadocs/components/sidebar/page-tree';
import {
  type GetSidebarTabsOptions,
  getSidebarTabs,
} from '@/components/fumadocs/components/sidebar/tabs';
import {
  SidebarTabsDropdown,
  type SidebarTabWithProps,
} from '@/components/fumadocs/components/sidebar/tabs/dropdown';
import { buttonVariants } from '@/components/fumadocs/components/ui/button';
import { TreeContextProvider } from '@/components/fumadocs/contexts/tree';
import {
  LayoutBody,
  LayoutContextProvider,
  LayoutHeader,
  LayoutTabs,
} from '@/components/fumadocs/layouts/docs/client';
import {
  Sidebar,
  ...
  SidebarTrigger,
  SidebarViewport,
} from '@/components/fumadocs/layouts/docs/sidebar';
import {
...
import {
  LanguageToggle,
  LanguageToggleText,
} from '@/components/fumadocs/layouts/shared/language-toggle';
import {
  LargeSearchToggle,
  SearchToggle,
} from '@/components/fumadocs/layouts/shared/search-toggle';
import { ThemeToggle } from '@/components/fumadocs/layouts/shared/theme-toggle';
